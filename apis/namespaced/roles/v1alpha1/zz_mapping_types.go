...
type MappingInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/tagesjump/provider-opensearch/apis/namespaced/opensearch/v1alpha1.Role
	...
	// A list of users.
	// +crossplane:generate:reference:type=github.com/tagesjump/provider-opensearch/apis/namespaced/opensearch/v1alpha1.User
	// +listType=set
